...
//                        parquimetrosMaisProximosArray.add(item);
            ...
            complain("Result " + resultsMaisProximos[5]);
            //complain(parquimetrosMaisProximosArray.toArray().toString());
