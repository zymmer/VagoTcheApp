...
public class ExpandableAdapterWithButtons extends BaseExpandableListAdapter {
    private List<String> listGroup;
    private HashMap<String, List<String>> listData;
    private LayoutInflater inflater;

    public ExpandableAdapterWithButtons(Context context, List<String> listGroup, HashMap<String, List<String>> listData){
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent){
        ...
        if (convertView == null){
            ...
            //teste
            //holder.bt_botao = (Button) convertView.findViewById(R.id.bt_botao);
        ...
        //teste
        //holder.bt_botao.setText(listGroup.get(groupPosition));

                //setBackgroundResource(R.mipmap.cross);
