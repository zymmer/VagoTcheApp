...
public class ExpandableAdapter3Camadas extends BaseExpandableListAdapter {
    private List<String> listGroup;
    private HashMap<String, List<String>> listData, listDataOfData;
    private LayoutInflater inflater;

    public ExpandableAdapter3Camadas(Context context, List<String> listGroup, HashMap<String, List<String>> listData, HashMap<String, List<String>> listDataOfData){
        this.listGroup = listGroup;
        this.listData = listData;
        this.listDataOfData = listDataOfData;
